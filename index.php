...
@keyframes slide{
   		    0% { background-image: url("images/img_1.jpg"); }
		20% { background-image: url("images/img_2.jpg"); }
		40% { background-image: url("images/img_3.jpg"); }
		60% { background-image: url("images/img_4.jpg"); }
		80% { background-image: url("images/img_5.jpg"); }
		100% { background-image: url("images/img_1.jpg"); } 
...
<section class="hero bg-image" data-image-src="images/food1.jpg">
	 <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Order Now Taste The Best  </h1>
                        ...
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                <div class="icon" data-step="1">
                                    ...
                                    <p style="color:white;">We"ve got your covered with menus from a variety of delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
<div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                <div class="step step-2">
                        <div class="icon" data-step="2">
                                ...
                                <h3>Choose a dish</h3>
                                <p style="color:white;">We"ve got your covered with a variety of delivery restaurants online.</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info" style="color:white;">Cash on Delivery</p>
                    </div>
                </div>
            </div>
        </section>
